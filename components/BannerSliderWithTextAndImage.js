                        ...
                        <div className="h-full relative overflow-hidden">
                            <div className="pt-12 pb-32 relative z-10">
                                ...
                                <div className="">
                                    ...
                                    <br />
                                    <span className="mt-1 inline-block text-8xl font-black font-sans bg-dust-primary py-1 px-5">BIG SALE</span>
                                    <br />
                    ...
                    <div className="relative overflow-hidden">
                        <div className="pt-12 pb-32 relative z-10">
                            ...
                            <div className="">
                                ...
                                <br />
                                <span className="mt-2 inline-block text-4xl font-semibold bg-dust-primary text-black py-1 px-5 text-white rounded-lg font-serif">UP TO 30% OFF</span>
                            </div>
                            <div className="mt-16">
                    ...
                    <Container className="h-full">
                        <div className="h-full relative overflow-hidden">
                            <div className="pt-12 pb-32 relative z-10 flex flex-col items-center">
                                ...
                                <div className="mt-16">
                                    <LinkAsButton href="/" dust-secondary>View article</LinkAsButton>
                                </div>
                            </div>
                        </div>
