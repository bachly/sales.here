...
import { sampleProductsFilePaths, SAMPLE_PRODUCT_PATH } from './utils';
...
export function getAllSampleProductFiles() {
  const allFiles = sampleProductsFilePaths.map((filePath) => {
    return {
      filePath
    }
  })
